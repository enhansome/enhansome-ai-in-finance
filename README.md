...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 108,322 | 🐛 179 | 🌐 Python | 📅 2026-09-23 - Multi-Agents LLM Financial Trading Framework.

* [Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) ⭐ 33,896 | 🐛 35 | 🌐 Python | 📅 2026-09-23 - Multi-agent finance research workspace for strategy generation, backtests, portfolio analysis, and research insights.

* 🌟🌟 [nofx](https://github.com/NoFxAiOS/nofx) ⭐ 12,953 | 🐛 518 | 🌐 Go | 📅 2026-09-05 - A multi-exchange Al trading platform with multi-Ai competition self-evolution, and real-time dashboard.

* 🌟 [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 8,072 | 🐛 76 | 🌐 Jupyter Notebook | 📅 2026-09-11 - An Open-Source AI Agent Platform for Financial Analysis using LLMs.

* 🌟 [ATLAS](https://github.com/chrisworsey55/atlas-gic) ⭐ 2,192 | 🐛 4 | 🌐 Python | 📅 2026-09-22 - Self-improving AI trading system with 25 agents, Karpathy-style autoresearch, Darwinian selection, autonomous agent spawning, and multi-cohort meta-weighting.

* [oracle3](https://github.com/YichengYang-Ethan/oracle3) ⭐ 257 | 🐛 18 | 🌐 Python | 📅 2026-05-08 - Prediction-market trading agent for Kalshi, Polymarket, and Solana DFlow, with Wang Transform pricing and arbitrage strategies.
...
* [TraceArena](https://github.com/tonyhyworld/TraceArena) ⭐ 1 | 🐛 12 | 🌐 Python | 📅 2026-09-23 - Open-source runtime for auditable multi-agent investment evaluation with evidence-linked actions, deterministic simulated settlement, and reproducible replay; no brokerage connection.
...
* 🌟 [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) ⭐ 63,696 | 🐛 167 | 🌐 Python | 📅 2026-09-22 - Explore the use of AI to make trading decisions.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 21,282 | 🐛 52 | 🌐 Jupyter Notebook | 📅 2026-09-23 - Provides a playground for all people interested in LLMs and NLP in Finance.
...
* 🌟🌟 [MarS](https://github.com/microsoft/MarS) ⭐ 1,791 | 🐛 16 | 🌐 Python | 📅 2026-09-23 - A Financial Market Simulation Engine Powered by Generative Foundation Model.
...
* [Quant Research](https://github.com/Jimmy7892/quant-research-skill) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-08-23 - Agent skill for backtest validation using parameter stability, selection-bias checks, and walk-forward evaluation.
...
* [atilaahmettaner/tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp) ⭐ 4,622 | 🐛 16 | 🌐 Python | 📅 2026-09-01 - 30+ tools for real-time TradingView market data, technical analysis, screeners, and backtesting across stocks, crypto, forex, and futures.
* [dgunning/edgartools](https://github.com/dgunning/edgartools) ⭐ 2,741 | 🐛 31 | 🌐 Python | 📅 2026-09-22 - 11 MCP tools for SEC EDGAR — every filing type (10-K, 10-Q, 8-K, S-1), no API key required; 1,800+ Smithery installs.
* [financial-datasets/mcp-server](https://github.com/financial-datasets/mcp-server) ⭐ 2,301 | 🐛 16 | 🌐 Python | 📅 2025-06-05 - Structured access to income statements, balance sheets, cash flows, stock prices, and market news via the Financial Datasets API.
* [guangxiangdebizi/FinanceMCP](https://github.com/guangxiangdebizi/FinanceMCP) ⭐ 860 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-21 - Integrates Tushare (Chinese A-shares, funds, bonds, macro) and Binance (crypto) for LLM financial data access.
* [TickDB/tickdb-unified-realtime-marketdata-api](https://github.com/TickDB/tickdb-unified-realtime-marketdata-api) ⭐ 817 | 🐛 4 | 🌐 Python | 📅 2026-06-20 - 13-tool unified real-time and historical market data across Forex, US/HK/CN stocks, and crypto.
* [massive-com/mcp\_massive](https://github.com/massive-com/mcp_massive) ⭐ 391 | 🐛 12 | 🌐 Python | 📅 2026-06-11 - Polygon.io professional-grade real-time and historical data for stocks, forex, crypto, and options.
...
* [zwldarren/akshare-one-mcp](https://github.com/zwldarren/akshare-one-mcp) ⭐ 230 | 🐛 5 | 🌐 Python | 📅 2026-09-24 - AKShare API for Chinese stock market: historical prices, real-time quotes, financial reports, and news.
...
* [koreainvestment/open-trading-api](https://github.com/koreainvestment/open-trading-api) ⭐ 1,615 | 🐛 40 | 🌐 Python | 📅 2026-08-26 - **Official** Korea Investment & Securities Open API with MCP and LLM integration for Korean equity market trading.
* [alpacahq/alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server) ⭐ 988 | 🐛 23 | 🌐 Python | 📅 2026-09-15 - **Official** Alpaca MCP server: natural-language trading of US stocks, ETFs, options, and crypto.
* [ariadng/metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server) ⭐ 810 | 🐛 29 | 🌐 Python | 📅 2026-03-28 - MCP bridge to MetaTrader 5 for natural-language trade execution and live position tracking across forex and futures.
* [krakenfx/kraken-cli](https://github.com/krakenfx/kraken-cli) ⭐ 731 | 🐛 7 | 🌐 Rust | 📅 2026-08-07 - **Official** Kraken AI-native CLI with built-in MCP support for spot trading, portfolio management, and market data.
* [okx/agent-trade-kit](https://github.com/okx/agent-trade-kit) ⭐ 438 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-23 - **Official** OKX MCP server: AI agent trading of spot, perpetuals, and futures with full order management.
...
* [wshobson/maverick-mcp](https://github.com/wshobson/maverick-mcp) ⭐ 677 | 🐛 10 | 🌐 Python | 📅 2026-09-19 - Personal stock analysis MCP server: technical indicators, earnings calendars, options flow, and insider trades.
...
* [heubme2020/datasinking](https://github.com/heubme2020/datasinking) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - Open-source MCP server for Asian financial reports as Markdown, with chapter-level access. Requires a DataSinking API key; usage limits apply.
...
* [FinRL](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 16,383 | 🐛 314 | 🌐 Jupyter Notebook | 📅 2026-09-23 - A Deep Reinforcement Learning Library for Automated Stock Trading in Quantitative Finance.
...
* 🌟 [Ensemble-Strategy](https://github.com/AI4Finance-LLC/Deep-Reinforcement-Learning-for-Automated-Stock-Trading-Ensemble-Strategy-ICAIF-2020) ⭐ 3,743 | 🐛 54 | 🌐 Python | 📅 2026-09-18 - Deep Reinforcement Learning for Automated Stock Trading.
...
* [skfolio](https://github.com/skfolio/skfolio) ⭐ 2,431 | 🐛 38 | 🌐 Python | 📅 2026-09-23 - Python library for portfolio optimization built on top of scikit-learn.
...
* [ml-quant-trading](https://github.com/initial-d/ml-quant-trading) ⭐ 89 | 🐛 3 | 🌐 Python | 📅 2026-09-20 - PyTorch research stack for mask-aware multi-factor modeling, ML baselines, portfolio optimization, and vectorized backtesting.
...
* [quant-trading](https://github.com/je-suis-tm/quant-trading) ⭐ 10,765 | 🐛 0 | 🌐 Python | 📅 2026-06-20 - Python quantitative trading strategies.
...
* [PineTS](https://github.com/LuxAlgo/PineTS) ⭐ 688 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-23 - Open-source Pine Script transpiler and runtime for indicators and strategies in Node.js and browsers, using live or custom market data.
* [Wickra](https://github.com/wickra-lib/wickra) ⭐ 56 | 🐛 1 | 🌐 Rust | 📅 2026-09-24 - Native library computing 500+ technical-analysis indicators over OHLC data, streaming-first; Rust core with Python, Node.js, WASM and a C ABI (C/C++/C#/Go/Java/R) bindings.
...
* [Tushare](https://github.com/waditu/tushare) ⭐ 15,420 | 🐛 767 | 🌐 Python | 📅 2024-03-13 - TuShare is a utility for crawling historical data of China stocks.
...
* [The Stall](https://github.com/thebrierfox/the-stall) ⭐ 0 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-21 - Pay-per-call API and MCP service aggregating stock, macroeconomic, crypto, and prediction-market data from third-party sources.
...
* [WorldMonitor](https://github.com/koala73/worldmonitor) ⭐ 87,287 | 🐛 348 | 🌐 TypeScript | 📅 2026-09-23 - AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface.
...
* 🌟🌟 [TensorTrade](https://github.com/tensortrade-org/tensortrade) ⭐ 7,150 | 🐛 49 | 🌐 Python | 📅 2026-02-19 - Trade efficiently with reinforcement learning.
...
* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,313 | 🐛 22 | 🌐 Python | 📅 2026-07-01 - Zero vector trader.
* [WFGY](https://github.com/onestardao/WFGY) ⭐ 1,794 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-09-23 – Open source framework for debugging and stress testing LLM agents and RAG pipelines. Includes a 16 mode failure map and long-horizon stress tests that are useful for financial research agents.
...
* 🌟🌟🌟 [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 73,413 | 🐛 107 | 🌐 Python | 📅 2026-09-23 - AI-powered opensource research and analytics workspace.
* [backtrader](https://github.com/backtrader/backtrader) ⭐ 23,313 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* [lean](https://github.com/QuantConnect/Lean) ⭐ 21,745 | 🐛 265 | 🌐 C# | 📅 2026-09-23 - Algorithmic trading engine built for easy strategy research, backtesting and live trading.
* 🌟🌟 [zipline](https://github.com/quantopian/zipline) ⭐ 20,111 | 🐛 368 | 🌐 Python | 📅 2024-02-13 - A python algorithmic trading library.
* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,793 | 🐛 33 | 🌐 Python | 📅 2026-09-23 - A extendable, replaceable Python algorithmic backtest & trading framework.
* [kungfu](https://github.com/taurusai/kungfu) ⭐ 4,522 | 🐛 94 | 🌐 C++ | 📅 2026-09-19 - Kungfu Master trading system.
...
* [abu](https://github.com/bbfamily/abu) ⭐ 18,687 | 🐛 6 | 🌐 Python | 📅 2026-01-24 - A quant trading system base on python.
...
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,507 | 🐛 42 | 🌐 Python | 📅 2026-08-06 - High-performance TensorFlow library for quantitative finance.

### Visualizing

* [netron](https://github.com/lutzroeder/netron) ⭐ 33,516 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-22 - Visualizer for deep learning and machine learning models.
* [playground](https://github.com/tensorflow/playground) ⭐ 13,033 | 🐛 146 | 🌐 TypeScript | 📅 2026-06-10 - Play with neural networks.
* [KLineChart](https://github.com/liihuu/KLineChart) ⭐ 4,164 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-18 - Highly customizable professional lightweight financial charts
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 29,720 | 🐛 83 | 🌐 HTML | 📅 2026-09-23 - A curated list of insanely awesome libraries, packages and resources for Quants (Quantitative Finance).
...
* 🌟🌟 [Financial Machine Learning](https://github.com/firmai/financial-machine-learning) ⭐ 8,791 | 🐛 15 | 🌐 Python | 📅 2025-01-03 - A curated list of practical financial machine learning (FinML) tools and applications. This collection is primarily in Python.
...
* [FinancePy](https://github.com/domokane/FinancePy) ⭐ 3,156 | 🐛 50 | 🌐 Python | 📅 2026-09-23 - A Python Finance Library that focuses on the pricing and risk-management of Financial Derivatives, including fixed-income, equity, FX and credit derivatives.
