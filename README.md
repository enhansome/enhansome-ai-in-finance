...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 107,616 | 🐛 160 | 🌐 Python | 📅 2026-09-18 - Multi-Agents LLM Financial Trading Framework.

* [Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) ⭐ 33,694 | 🐛 42 | 🌐 Python | 📅 2026-09-19 - Multi-agent finance research workspace for strategy generation, backtests, portfolio analysis, and research insights.

* 🌟🌟 [nofx](https://github.com/NoFxAiOS/nofx) ⭐ 12,921 | 🐛 518 | 🌐 Go | 📅 2026-09-05 - A multi-exchange Al trading platform with multi-Ai competition self-evolution, and real-time dashboard.

* 🌟 [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 8,033 | 🐛 76 | 🌐 Jupyter Notebook | 📅 2026-09-11 - An Open-Source AI Agent Platform for Financial Analysis using LLMs.

* 🌟 [ATLAS](https://github.com/chrisworsey55/atlas-gic) ⭐ 2,186 | 🐛 4 | 🌐 Python | 📅 2026-05-27 - Self-improving AI trading system with 25 agents, Karpathy-style autoresearch, Darwinian selection, autonomous agent spawning, and multi-cohort meta-weighting.
...
* [Nova-TradingAgent](https://github.com/rufeng0411/Nova-TradingAgent) ⭐ 26 | 🐛 6 | 🌐 Python | 📅 2026-09-10 - Self-hosted A-share research workbench built on TradingAgents, with a web interface and no brokerage connection by default.

* [OpenCandle](https://github.com/Kahtaf/opencandle) ⭐ 25 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-19 - Open-source financial research agent with real-time market data, local portfolios and watchlists, and no trade execution.
...
* [TraceArena](https://github.com/tonyhyworld/TraceArena) ⭐ 1 | 🐛 8 | 🌐 Python | 📅 2026-09-16 - Open-source runtime for auditable multi-agent investment evaluation with evidence-linked actions, deterministic simulated settlement, and reproducible replay; no brokerage connection.
...
* 🌟 [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) ⭐ 63,548 | 🐛 165 | 🌐 Python | 📅 2026-09-18 - Explore the use of AI to make trading decisions.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 21,270 | 🐛 53 | 🌐 Jupyter Notebook | 📅 2026-09-14 - Provides a playground for all people interested in LLMs and NLP in Finance.
...
* 🌟🌟 [MarS](https://github.com/microsoft/MarS) ⭐ 1,784 | 🐛 16 | 🌐 Python | 📅 2026-08-31 - A Financial Market Simulation Engine Powered by Generative Foundation Model.
...
* [financeskills](https://github.com/GAJETOso/financeskills) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Agent skills for financial reporting, audit, reconciliation, journal entries, and accounting workflows referencing IFRS and GAAP.
...
* [AI Trader Team](https://github.com/TLSRUF/ai-trader-team) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2026-09-19 - Claude Code skills and agents for investment research, with deterministic position-sizing, portfolio-risk, and walk-forward backtesting tools.
...
* [atilaahmettaner/tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp) ⭐ 4,586 | 🐛 16 | 🌐 Python | 📅 2026-09-01 - 30+ tools for real-time TradingView market data, technical analysis, screeners, and backtesting across stocks, crypto, forex, and futures.
* [dgunning/edgartools](https://github.com/dgunning/edgartools) ⭐ 2,729 | 🐛 32 | 🌐 Python | 📅 2026-09-17 - 11 MCP tools for SEC EDGAR — every filing type (10-K, 10-Q, 8-K, S-1), no API key required; 1,800+ Smithery installs.
* [financial-datasets/mcp-server](https://github.com/financial-datasets/mcp-server) ⭐ 2,297 | 🐛 16 | 🌐 Python | 📅 2025-06-05 - Structured access to income statements, balance sheets, cash flows, stock prices, and market news via the Financial Datasets API.
* [guangxiangdebizi/FinanceMCP](https://github.com/guangxiangdebizi/FinanceMCP) ⭐ 852 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-18 - Integrates Tushare (Chinese A-shares, funds, bonds, macro) and Binance (crypto) for LLM financial data access.
* [TickDB/tickdb-unified-realtime-marketdata-api](https://github.com/TickDB/tickdb-unified-realtime-marketdata-api) ⭐ 803 | 🐛 3 | 🌐 Python | 📅 2026-06-20 - 13-tool unified real-time and historical market data across Forex, US/HK/CN stocks, and crypto.
* [massive-com/mcp\_massive](https://github.com/massive-com/mcp_massive) ⭐ 391 | 🐛 11 | 🌐 Python | 📅 2026-06-11 - Polygon.io professional-grade real-time and historical data for stocks, forex, crypto, and options.
* [Alex2Yang97/yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp) ⭐ 354 | 🐛 10 | 🌐 Python | 📅 2026-09-19 - Yahoo Finance MCP: stock quotes, financials, options chains, and market news.
* [zwldarren/akshare-one-mcp](https://github.com/zwldarren/akshare-one-mcp) ⭐ 227 | 🐛 4 | 🌐 Python | 📅 2026-09-19 - AKShare API for Chinese stock market: historical prices, real-time quotes, financial reports, and news.
* [alphavantage/alpha\_vantage\_mcp](https://github.com/alphavantage/alpha_vantage_mcp) ⭐ 211 | 🐛 2 | 🌐 Python | 📅 2026-09-18 - **Official** Alpha Vantage MCP server: real-time and historical data for stocks, forex, crypto, options, and ETFs.
* [livetennisapi/livetennisapi-mcp](https://github.com/livetennisapi/livetennisapi-mcp) ⭐ 150 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-14 - Open-source MCP server for tennis scores, fixtures, rankings, and win probabilities for prediction-market research. API plan limits apply.
* [imbenrabi/Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server) ⭐ 147 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-02 - 250+ Financial Modeling Prep API tools: financials, technical indicators, insider trading, SEC filings, earnings, and crypto.
...
* [koreainvestment/open-trading-api](https://github.com/koreainvestment/open-trading-api) ⭐ 1,609 | 🐛 40 | 🌐 Python | 📅 2026-08-26 - **Official** Korea Investment & Securities Open API with MCP and LLM integration for Korean equity market trading.
* [alpacahq/alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server) ⭐ 976 | 🐛 23 | 🌐 Python | 📅 2026-09-15 - **Official** Alpaca MCP server: natural-language trading of US stocks, ETFs, options, and crypto.
* [ariadng/metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server) ⭐ 808 | 🐛 29 | 🌐 Python | 📅 2026-03-28 - MCP bridge to MetaTrader 5 for natural-language trade execution and live position tracking across forex and futures.
* [krakenfx/kraken-cli](https://github.com/krakenfx/kraken-cli) ⭐ 725 | 🐛 7 | 🌐 Rust | 📅 2026-08-07 - **Official** Kraken AI-native CLI with built-in MCP support for spot trading, portfolio management, and market data.
* [okx/agent-trade-kit](https://github.com/okx/agent-trade-kit) ⭐ 436 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-14 - **Official** OKX MCP server: AI agent trading of spot, perpetuals, and futures with full order management.
...
* [rcontesti/IB\_MCP](https://github.com/rcontesti/IB_MCP) ⭐ 141 | 🐛 3 | 🌐 Python | 📅 2025-10-23 - Interactive Brokers TWS/Gateway MCP server for live trading and market access across 150 markets.
...
* [mnemox-ai/tradememory-protocol](https://github.com/mnemox-ai/tradememory-protocol) ⭐ 1,420 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - Open-source memory MCP for AI trading agents: three-layer architecture (raw memory → pattern reflection → strategy evolution).
* [wshobson/maverick-mcp](https://github.com/wshobson/maverick-mcp) ⭐ 675 | 🐛 10 | 🌐 Python | 📅 2026-09-19 - Personal stock analysis MCP server: technical indicators, earnings calendars, options flow, and insider trades.
* [stefanoamorelli/sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp) ⭐ 358 | 🐛 9 | 🌐 Python | 📅 2026-09-19 - Direct SEC EDGAR access for AI assistants: 10-K, 10-Q, 8-K filings, and insider trading data.
* [heubme2020/datasinking](https://github.com/heubme2020/datasinking) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Open-source MCP server for Asian financial reports as Markdown, with chapter-level access. Requires a DataSinking API key; usage limits apply.
...
* 🌟 [QuantResearch](https://github.com/letianzj/QuantResearch) ⭐ 3,032 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-08-26 - Quantitative analysis, strategies and backtests <https://letianzj.github.io/>
...
* [The Automation Ahead](https://github.com/CFA-Institute-RPC/The-Automation-Ahead) ⭐ 70 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-05-08 - CFA Institute examples for GenAI-driven investment workflows.
...
* [FinRL](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 16,330 | 🐛 312 | 🌐 Jupyter Notebook | 📅 2026-07-13 - A Deep Reinforcement Learning Library for Automated Stock Trading in Quantitative Finance.
...
* 🌟 [Ensemble-Strategy](https://github.com/AI4Finance-LLC/Deep-Reinforcement-Learning-for-Automated-Stock-Trading-Ensemble-Strategy-ICAIF-2020) ⭐ 3,727 | 🐛 54 | 🌐 Python | 📅 2026-09-18 - Deep Reinforcement Learning for Automated Stock Trading.
...
* [skfolio](https://github.com/skfolio/skfolio) ⭐ 2,416 | 🐛 47 | 🌐 Python | 📅 2026-09-19 - Python library for portfolio optimization built on top of scikit-learn.
...
* [DeepDow](https://github.com/jankrepl/deepdow) ⭐ 1,184 | 🐛 27 | 🌐 Python | 📅 2024-01-24 - Portfolio optimization with deep learning.
* [Deep-Reinforcement-Stock-Trading](https://github.com/Albert-Z-Guo/Deep-Reinforcement-Stock-Trading) ⭐ 692 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2024-11-06 - A light-weight deep reinforcement learning framework for portfolio management.
* [qtrader](https://github.com/filangel/qtrader) ⚠️ Archived - Reinforcement Learning for portfolio management.
* [ml-quant-trading](https://github.com/initial-d/ml-quant-trading) ⭐ 87 | 🐛 3 | 🌐 Python | 📅 2026-09-19 - PyTorch research stack for mask-aware multi-factor modeling, ML baselines, portfolio optimization, and vectorized backtesting.

### High Frequency Trading

* [High-Frequency-Trading-Model-with-IB](https://github.com/jamesmawm/High-Frequency-Trading-Model-with-IB) ⭐ 2,933 | 🐛 12 | 🌐 Python | 📅 2025-05-29 - A high-frequency trading model using Interactive Brokers API with pairs and mean-reversion.
* 🌟 [SGX-Full-OrderBook-Tick-Data-Trading-Strategy](https://github.com/rorysroes/SGX-Full-OrderBook-Tick-Data-Trading-Strategy) ⭐ 2,339 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2022-08-27 - Solutions for high-frequency trading (HFT) strategies using data science approaches (Machine Learning) on Full Orderbook Tick Data.
...
* [DeepAlpha](https://github.com/stefanoviana/deepalpha) ⭐ 46 | 🐛 17 | 🌐 Python | 📅 2026-05-12 - AI-powered crypto trading bot with 3-model ML ensemble (XGBoost, LightGBM, CatBoost), 12 exchanges via CCXT, walk-forward validated.

### Technical Analysis

* [quant-trading](https://github.com/je-suis-tm/quant-trading) ⭐ 10,749 | 🐛 0 | 🌐 Python | 📅 2026-06-20 - Python quantitative trading strategies.
* [crypto-signal](https://github.com/CryptoSignal/crypto-signal) ⭐ 5,639 | 🐛 56 | 🌐 Python | 📅 2024-07-07 - Automated crypto trading & technical analysis (TA) bot for Bittrex, Binance, GDAX, and more.
* [Gekko-Strategies](https://github.com/xFFFFF/Gekko-Strategies) ⭐ 1,440 | 🐛 19 | 🌐 JavaScript | 📅 2020-01-09 - Strategies to Gekko trading bot with backtests results and some useful tools.
...
* [PineTS](https://github.com/LuxAlgo/PineTS) ⭐ 666 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-17 - Open-source Pine Script transpiler and runtime for indicators and strategies in Node.js and browsers, using live or custom market data.
* [Wickra](https://github.com/wickra-lib/wickra) ⭐ 56 | 🐛 1 | 🌐 Rust | 📅 2026-09-19 - Native library computing 500+ technical-analysis indicators over OHLC data, streaming-first; Rust core with Python, Node.js, WASM and a C ABI (C/C++/C#/Go/Java/R) bindings.
...
* [Tushare](https://github.com/waditu/tushare) ⭐ 15,409 | 🐛 766 | 🌐 Python | 📅 2024-03-13 - TuShare is a utility for crawling historical data of China stocks.
* [yahoo-finance](https://github.com/lukaszbanasiak/yahoo-finance) ⭐ 1,448 | 🐛 88 | 🌐 Python | 📅 2023-12-25 - Python module to get stock data from Yahoo! Finance.
...
* [The Stall](https://github.com/thebrierfox/the-stall) ⭐ 7 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-18 - Pay-per-call API and MCP service aggregating stock, macroeconomic, crypto, and prediction-market data from third-party sources.
...
* [Satoshi API](https://github.com/Bortlesboat/bitcoin-api) ⭐ 5 | 🐛 11 | 🌐 Python | 📅 2026-09-12 - Bitcoin fee intelligence API with 108 endpoints for fee estimates, mempool analysis, block data, and mining stats. Self-hostable, Apache 2.0.
* [CoinPulse](https://github.com/soutone/coinpulse-python) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-01-09 - Python SDK for cryptocurrency portfolio tracking with real-time prices, P/L calculations, backtesting, and price alerts. Free tier: 25 req/hr.
...
* [WorldMonitor](https://github.com/koala73/worldmonitor) ⭐ 87,011 | 🐛 427 | 🌐 TypeScript | 📅 2026-09-19 - AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface.
...
* 🌟🌟 [TensorTrade](https://github.com/tensortrade-org/tensortrade) ⭐ 7,124 | 🐛 49 | 🌐 Python | 📅 2026-02-19 - Trade efficiently with reinforcement learning.
* [pyfolio](https://github.com/quantopian/pyfolio) ⭐ 6,422 | 🐛 166 | 🌐 Jupyter Notebook | 📅 2023-12-23 - Portfolio and risk analytics in Python.
...
* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,307 | 🐛 22 | 🌐 Python | 📅 2026-07-01 - Zero vector trader.
* [WFGY](https://github.com/onestardao/WFGY) ⭐ 1,791 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-09-19 – Open source framework for debugging and stress testing LLM agents and RAG pipelines. Includes a 16 mode failure map and long-horizon stress tests that are useful for financial research agents.
* [empyrical](https://github.com/quantopian/empyrical) ⭐ 1,513 | 🐛 37 | 🌐 Python | 📅 2024-07-26 - Common financial risk and performance metrics. Used by Zipline and pyfolio.
...
* 🌟🌟🌟 [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 73,259 | 🐛 114 | 🌐 Python | 📅 2026-09-19 - AI-powered opensource research and analytics workspace.
* [backtrader](https://github.com/backtrader/backtrader) ⭐ 23,284 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* [lean](https://github.com/QuantConnect/Lean) ⭐ 21,684 | 🐛 253 | 🌐 C# | 📅 2026-09-18 - Algorithmic trading engine built for easy strategy research, backtesting and live trading.
* 🌟🌟 [zipline](https://github.com/quantopian/zipline) ⭐ 20,100 | 🐛 368 | 🌐 Python | 📅 2024-02-13 - A python algorithmic trading library.
* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,779 | 🐛 31 | 🌐 Python | 📅 2026-09-18 - A extendable, replaceable Python algorithmic backtest & trading framework.
* [kungfu](https://github.com/taurusai/kungfu) ⭐ 4,520 | 🐛 94 | 🌐 C++ | 📅 2026-09-19 - Kungfu Master trading system.
* [the0](https://github.com/alexanderwanyoike/the0) ⭐ 432 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-01 - Self-hosted execution engine for algorithmic trading bots. Supports Python, TypeScript, Rust, C++, C#, Scala, and Haskell. Each bot runs in an isolated container with scheduled or streaming execution.
...
* [pylivetrader](https://github.com/alpacahq/pylivetrader) ⭐ 685 | 🐛 22 | 🌐 Python | 📅 2022-10-04 - Python live trade execution library with zipline interface.
...
* [abu](https://github.com/bbfamily/abu) ⭐ 18,656 | 🐛 6 | 🌐 Python | 📅 2026-01-24 - A quant trading system base on python.
...
* [techan.js](https://github.com/andredumas/techan.js) ⭐ 2,436 | 🐛 100 | 🌐 JavaScript | 📅 2020-10-02 - A visual, technical analysis and charting (Candlestick, OHLC, indicators) library built on D3.
...
* [ctpwrapper](https://github.com/nooperpudd/ctpwrapper) ⭐ 610 | 🐛 18 | 🌐 Python | 📅 2026-06-08 - Shanghai future exchange CTP api.
...
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,502 | 🐛 42 | 🌐 Python | 📅 2026-08-06 - High-performance TensorFlow library for quantitative finance.

### Visualizing

* [netron](https://github.com/lutzroeder/netron) ⭐ 33,497 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-19 - Visualizer for deep learning and machine learning models.
* [playground](https://github.com/tensorflow/playground) ⭐ 13,027 | 🐛 146 | 🌐 TypeScript | 📅 2026-06-10 - Play with neural networks.
* [KLineChart](https://github.com/liihuu/KLineChart) ⭐ 4,154 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-18 - Highly customizable professional lightweight financial charts

### GYM Environment

* 🌟 [TradingGym](https://github.com/Yvictor/TradingGym) ⭐ 1,919 | 🐛 11 | 🌐 Python | 📅 2024-02-11 - Trading and Backtesting environment for training reinforcement learning agent.
* [btgym](https://github.com/Kismuz/btgym) ⭐ 1,035 | 🐛 11 | 🌐 Python | 📅 2021-08-28 - Scalable, event-driven, deep-learning-friendly backtesting library.
...
* [TraderHarness](https://github.com/HephaestLab/TraderHarness) ⭐ 38 | 🐛 1 | 🌐 Python | 📅 2026-08-22 - Contamination-resistant A-share backtesting environment for LLM trading agents, with point-in-time masking, entity/date anonymization, fingerprinted replay, and trajectory (SFT) export.

## Articles

* [The-Economist](https://github.com/nailperry-zd/The-Economist) ⭐ 3,950 | 🐛 19 | 📅 2023-06-23 - The Economist.
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 29,659 | 🐛 70 | 🌐 HTML | 📅 2026-09-19 - A curated list of insanely awesome libraries, packages and resources for Quants (Quantitative Finance).
...
* 🌟🌟 [Financial Machine Learning](https://github.com/firmai/financial-machine-learning) ⭐ 8,786 | 🐛 15 | 🌐 Python | 📅 2025-01-03 - A curated list of practical financial machine learning (FinML) tools and applications. This collection is primarily in Python.
...
* [FinancePy](https://github.com/domokane/FinancePy) ⭐ 3,153 | 🐛 49 | 🌐 Python | 📅 2026-09-19 - A Python Finance Library that focuses on the pricing and risk-management of Financial Derivatives, including fixed-income, equity, FX and credit derivatives.
